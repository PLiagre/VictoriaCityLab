# Tableau de bord Hermes — Victoria CityLab

## Pipeline

- Evenements d'audit: 16
- Pull requests recentes: 10
- Workflows recents: 10
...
- [#13 — fix: separate Cursor audit from Claude challenge](https://github.com/PLiagre/VictoriaCityLab/pull/13) — MERGED
- [#12 — audit: PR #11](https://github.com/PLiagre/VictoriaCityLab/pull/12) — MERGED
- [#11 — proof: full-auto cycle CITYLAB-20260812T142054Z](https://github.com/PLiagre/VictoriaCityLab/pull/11) — CLOSED
...
- `AUDIT_PROPOSED` — `CURSOR-20260812T142310Z-pr-11` — cursor-agent
- `AUDIT_CHALLENGED` — `CURSOR-20260812T142310Z-pr-11` — claude
- `AUDIT_REJECTED` — `CURSOR-20260812T142310Z-pr-11` — auto-policy
- `AUDIT_PROPOSED` — `CURSOR-20260812T143004Z-pr-14` — cursor-agent
- `AUDIT_CHALLENGED` — `CURSOR-20260812T143004Z-pr-14` — claude
- `AUDIT_APPROVED` — `CURSOR-20260812T143004Z-pr-14` — auto-policy
- `AUDIT_CONVERTED` — `CURSOR-20260812T143004Z-pr-14` — pipeline-orchestrator
- `AUDIT_IMPLEMENTED` — `CURSOR-20260812T143004Z-pr-14` — codex
- `AUDIT_VERIFIED` — `CURSOR-20260812T143004Z-pr-14` — github-actions
- `AUDIT_ARCHIVED` — `CURSOR-20260812T143004Z-pr-14` — pipeline-orchestrator

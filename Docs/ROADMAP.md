...
|---|---|---|---|---|
| 2026-08-12 | `META-AUTO-01` | L'évaluation indépendante accepte désormais les lots réels volumineux sous Windows : l'invite complète et le diff sont transmis à Claude par stdin, hors de la limite de longueur de ligne de commande. L'absence de verdict reste un échec fermé. | `WinError 206` reproduit par le run #31617561462 ; test stdin avec une invite de 100 000 caractères ; harnais et roadmap verts. | Relancer l'évaluation de `M3-BUILD-01`, incrément 02, depuis `main` corrigée. |
